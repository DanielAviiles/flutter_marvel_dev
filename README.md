...
### [lib/app/modules]
En esta capa ya está identificada la UI, donde se implementa una estructura a base del
nombre del modulo, application donde se ejecutan querys de modificación y consulta, domain
donde se encuentra la abstración de repositorios y modelos que se implementará en casos de uso,
